package com.xie.redis.springbootredis.util.redis.cache;
...
public class RedisAspect {
	 ...
	 */
	@Pointcut("@annotation(com.xie.redis.springbootredis.util.redis.annotation.RedisCache)")
	...
	public Object around(ProceedingJoinPoint joinPoint){
		...
		//redis中key格式：  方法名称：参数名
		String redisKey = className + "." + methodName + ":" + applId  ;
